...
const Color emerald = Color(0xFF0086B3);
const Color middleblue = Color(0xFF64B5F6);
const Color sky = Color(0xFF87CEEB);
const Color whiteblue = Color (0xFFE3F2FD);
const Color magenta = Color(0xFFFF00FF);
const Color baby = Color(0xFFF4C2C2);
